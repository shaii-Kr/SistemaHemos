$( document ).ready(function(){
    ...
    $.ajax({
        ...
        success: listar_infoDoador, // chama a função listar_pessoas para processar o resultado
        error: function() {
    ...
    $.ajax({
        ...
        method: 'GET',
        dataType: 'json', // os dados são recebidos no formato json
        success: listar_infoFuncionario, // chama a função listar_pessoas para processar o resultado
        error: function() {
            alert("erro ao ler dados, verifique o backend");
        }
    });
    ...
    $.ajax({
        ...
        method: 'GET',
        dataType: 'json', // os dados são recebidos no formato json
        success: listar_doacoes, // chama a função listar_pessoas para processar o resultado
        error: function() {
            alert("erro ao ler dados, verifique o backend");
        }
    });
